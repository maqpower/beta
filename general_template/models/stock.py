...
class StockPicking(models.Model):
    ...
    def _default_report_template1(self):
        ...
        self.report_template_id = self.partner_id and self.partner_id.report_picking_template_id.id or self.partner_id and self.partner_id.report_delivery_template_id.id or False
...
#         sys.setdefaultencoding("utf-8")
    ...
    report_template_id1 = fields.Many2one('ir.actions.report', string="Picking Template", compute='_default_report_template1',
